...
namespace EasyExchange\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('EasyExchange', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/EasyExchange/exchange.log',
    ...
    {
        return $config['name'] ?? 'EasyExchange';
    }
