...
class Client extends BaseClient
{
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function maxLoan($params)
    {
        return $this->httpGet('/api/v5/account/max-loan', $params, 'SIGN');
    }
    ...
    {
        return $this->httpGet('/api/v5/account/trade-fee', $params, 'SIGN');
    }
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function interestAccrued($params)
    {
        return $this->httpGet('/api/v5/account/interest-accrued', $params, 'SIGN');
    }
    ...
    {
        return $this->httpPostJson('/api/v5/account/set-greeks', compact('greeksType'), [], 'SIGN');
    }
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function maxWithdrawal($ccy = '')
    {
        return $this->httpGet('/api/v5/account/max-withdrawal', compact('ccy'), 'SIGN');
    }
}
